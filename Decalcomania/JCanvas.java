...
public class JCanvas extends JComponent implements Printable
{
  ...
  /** [Advanced] */
   public Graphics create() { Graphics2D g=getG();
  ...
  /** [Advanced] */
   public void dispose() {Graphics2D g=getG();
      if(g!=null)g.dispose();}
  //public void draw3DRect(int x, int y, int width, int height, boolean raised) {
  //  toBuffer(draw3DRect,mkArg(x, y, width, height, raised) );}
   ...
   private void doPaint(Graphics2D g,int s,Object o){
    ...
    //System.out.println(s);
      ...
      //{toBuffer("addRenderingHints",hints );}
         case addRenderingHints: g.addRenderingHints((Map<?,?>) o);
            break;
         case clip1:   g.clip((Shape) o) ;
            break;
         case draw1:   g.draw((Shape) o) ;
            break;
         ...
         case drawString2:   
            ...
            break;
         case drawString3:   g.drawString((String)o1, (Float)o2, (Float)o3) ;
            break;
         case drawString4:   g.drawString((String)o1, (Integer)o2, (Integer)o3) ;
            break;
         case fill:   g.fill((Shape)o) ;
            break;
         case fill3DRect:   
            g.fill3DRect((Integer)o1, (Integer)o2, (Integer)o3, (Integer)o4, (Boolean)o5) ;
            break;
         case rotate1:   g.rotate((Double)o) ;
            break;
         case rotate2:   g.rotate((Double)o1, (Double)o2, (Double)o3) ;
            break;
         case scale1:   g.scale((Double)o1, (Double)o2) ;
            break;
         case setBackground:   
            g.setBackground((Color)o) ; //paintBackground(g,(Color)o); /*super.setBackground((Color)o) ;*/
            break;
         case setComposite:   g.setComposite((Composite)o) ;
            break;
         case setPaint:   g.setPaint((Paint)o) ;
            break;
         case setRenderingHint:   g.setRenderingHint((RenderingHints.Key)o1, o2) ;
            break;
         case setRenderingHints:   g.setRenderingHints((Map<?,?>)o) ;
            break;
         case setStroke:   g.setStroke((Stroke)o) ;
            break;
         case setTransform:   g.setTransform(makeTransform(o)) ;
            break;
         case shear:   g.shear((Double)o1, (Double)o2) ;
            break;
         case transform1:   g.transform(makeTransform(o)) ;
            break;
         case translate1:   g.translate((Double)o1, (Double)o2) ;
            break;
         case translate2:   g.translate((Integer)o1, (Integer)o2) ;
            break;
         case clearRect:   
         ...
         case drawPolygon1:   
            ...
            break;
         case drawPolygon2:   g.drawPolygon((Polygon)o) ;
            break;
         case drawPolyline:   g.drawPolyline((int[])o1, (int[])o2, (Integer)o3) ;
            break;
         case drawRect:   
      ...
      //{toBuffer("fillPolygon",mkArg(xPoints,  yPoints, nPoints) );}
         case fillPolygon1:   g.fillPolygon((int[])o1, (int[])o2, (Integer)o3) ;
            break;
         case fillPolygon2:   g.fillPolygon((Polygon)o) ;
            break;
         case fillRect:   
         ...
         case fillRoundRect:   g.fillRoundRect((Integer)o1, (Integer)o2, (Integer)o3, 
            ...
            break;
         case setClip1:   g.setClip((Shape) o) ;
            break;
         case setColor:   g.setColor((Color)o) ;
            break;
         case setFont:   g.setFont((Font)o) ;
            break;
         case setPaintMode:   g.setPaintMode() ;
            break;
         case setXORMode:   g.setXORMode((Color)o) ;
            break;
         case opaque: super.setOpaque((Boolean)o) ;  
            break;
